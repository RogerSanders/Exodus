...
public:
	...
	//Stream position
	//##NOTE## When creating a non-seekable base class, the base should still have the
	//IsAtEnd() and SkipBytes() functions. The seekable interface will just add the
	//Size(), GetStreamPos(), and SetStreamPos() functions.
