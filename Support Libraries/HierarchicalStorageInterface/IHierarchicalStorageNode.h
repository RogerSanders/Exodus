...
public:
	...
	template<class T>
	IHierarchicalStorageNode& CreateChild(const std::wstring& name, const T& data);
	template<class T>
	IHierarchicalStorageNode& CreateChildHex(const std::wstring& name, const T& data, unsigned int length);
	template<class T>
	IHierarchicalStorageNode& CreateChildBinary(const std::wstring& name, const T& data, const std::wstring& bufferName, bool inlineBinaryData = true);
	template<class T>
	IHierarchicalStorageNode& CreateChildBinary(const std::wstring& name, const T* buffer, unsigned int entries, const std::wstring& bufferName, bool inlineBinaryData = true);
	...
	template<class T>
	IHierarchicalStorageNode& CreateAttribute(const std::wstring& name, const T& value);
	template<class T>
	IHierarchicalStorageNode& CreateAttributeHex(const std::wstring& name, const T& value, unsigned int length);
	template<class T>
	bool ExtractAttribute(const std::wstring& name, T& target);
	template<class T>
	bool ExtractAttributeHex(const std::wstring& name, T& target);
	...
	T ExtractHexData();
	template<class T>
	IHierarchicalStorageNode& ExtractData(T& target);
	template<class T>
	IHierarchicalStorageNode& ExtractHexData(T& target);

	// Data write functions
	template<class T>
	IHierarchicalStorageNode& SetData(const T& data);
	template<class T>
	IHierarchicalStorageNode& InsertData(const T& data);
	template<class T>
	IHierarchicalStorageNode& InsertHexData(const T& data, unsigned int length);
	...
	T ExtractBinaryData();
	template<class T>
	IHierarchicalStorageNode& ExtractBinaryData(T& target);

	// Binary data write functions
	template<class T>
	IHierarchicalStorageNode& InsertBinaryData(const T& data, const std::wstring& bufferName, bool inlineBinaryData = true);
	template<class T>
	IHierarchicalStorageNode& InsertBinaryData(const T* buffer, size_t entries, const std::wstring& bufferName, bool inlineBinaryData = true);
