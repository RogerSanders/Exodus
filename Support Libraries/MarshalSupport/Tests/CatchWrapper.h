...
public:
	...
	virtual void sectionEnded(Catch::SectionEndInfo const& endInfo) = 0;
	virtual void sectionEndedEarly(Catch::SectionEndInfo const& endInfo) = 0;
...
public:
	...
	virtual void sectionEnded(Catch::SectionEndInfo const& endInfo)
	{
		return target->sectionEnded(endInfo);
	}

	virtual void sectionEndedEarly(Catch::SectionEndInfo const& endInfo)
	{
		return target->sectionEndedEarly(endInfo);
	}
	...
	{
		return target->handleFatalErrorCondition(message);
	}
