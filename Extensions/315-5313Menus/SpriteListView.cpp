...
:ViewBase(uiManager, presenter), _presenter(presenter), _model(model)
{
	...
	_hwndDataGrid = NULL;
	SetWindowSettings(presenter.GetUnqualifiedViewTitle(), 0, 0, 640, 480);
	SetDockableViewType();
}
...
LRESULT SpriteListView::msgWM_CREATE(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
	...
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"Tiles", COLUMN_TILES, true));
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"Link", COLUMN_LINK, true));
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"HSize", COLUMN_HSIZE, true));
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"VSize", COLUMN_VSIZE, true));
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"P", COLUMN_P, true, WC_DataGrid::CellControlType::CheckBox));
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"HFlip", COLUMN_HFLIP, true, WC_DataGrid::CellControlType::CheckBox));
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"VFlip", COLUMN_VFLIP, true, WC_DataGrid::CellControlType::CheckBox));
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"C", COLUMN_C, true));
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"Word1", COLUMN_RAW0, true));
	SendMessage(_hwndDataGrid, (UINT)WC_DataGrid::WindowMessages::InsertColumn, 0, (LPARAM)&(const WC_DataGrid::Grid_InsertColumn&)WC_DataGrid::Grid_InsertColumn(L"Word2", COLUMN_RAW1, true));
...
LRESULT SpriteListView::msgWM_COMMAND(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
	if (LOWORD(wparam) == DataListControlID)
	{
		if ((WC_DataGrid::WindowNotifications)HIWORD(wparam) == WC_DataGrid::WindowNotifications::CellEdit)
		{
			...
			_model.SetSpriteMappingTableEntry(spriteMappingBaseAddress, cellEditEventInfo->targetRowNo, spriteMapping, useSeparatedData);
		}
	}
	return TRUE;
}
