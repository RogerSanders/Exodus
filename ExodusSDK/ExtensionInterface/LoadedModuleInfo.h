...
public:
	...
	virtual void SetModuleFilePath(const Marshal::In<std::wstring>& amoduleFilePath);
	...
	virtual void SetModuleClassName(const Marshal::In<std::wstring>& aclassName);
	virtual Marshal::Ret<std::wstring> GetModuleInstanceName() const;
	virtual void SetModuleInstanceName(const Marshal::In<std::wstring>& ainstanceName);
	virtual Marshal::Ret<std::wstring> GetModuleDisplayName() const;
	virtual void SetModuleDisplayName(const Marshal::In<std::wstring>& adisplayName);

	//Optional metadata
	virtual Marshal::Ret<std::wstring> GetProductionYear() const;
	virtual void SetProductionYear(const Marshal::In<std::wstring>& aproductionYear);
	virtual Marshal::Ret<std::wstring> GetManufacturerCode() const;
	virtual void SetManufacturerCode(const Marshal::In<std::wstring>& amanufacturerCode);
	virtual Marshal::Ret<std::wstring> GetManufacturerDisplayName() const;
	virtual void SetManufacturerDisplayName(const Marshal::In<std::wstring>& amanufacturerDisplayName);
