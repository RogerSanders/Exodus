...
//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetROM8(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new ROM8(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteROM8(IDevice* device)
{
	delete static_cast<ROM8*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetROM16(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new ROM16(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteROM16(IDevice* device)
{
	delete static_cast<ROM16*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetROM32(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new ROM32(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteROM32(IDevice* device)
{
	delete static_cast<ROM32*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetROM8Variable(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new ROM8Variable(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteROM8Variable(IDevice* device)
{
	delete static_cast<ROM8Variable*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetROM16Variable(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new ROM16Variable(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteROM16Variable(IDevice* device)
{
	delete static_cast<ROM16Variable*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetROM32Variable(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new ROM32Variable(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteROM32Variable(IDevice* device)
{
	delete static_cast<ROM32Variable*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetRAM8(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new RAM8(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteRAM8(IDevice* device)
{
	delete static_cast<RAM8*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetRAM16(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new RAM16(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteRAM16(IDevice* device)
{
	delete static_cast<RAM16*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetRAM32(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new RAM32(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteRAM32(IDevice* device)
{
	delete static_cast<RAM32*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetRAM8Variable(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new RAM8Variable(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteRAM8Variable(IDevice* device)
{
	delete static_cast<RAM8Variable*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetRAM16Variable(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new RAM16Variable(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteRAM16Variable(IDevice* device)
{
	delete static_cast<RAM16Variable*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetRAM32Variable(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new RAM32Variable(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteRAM32Variable(IDevice* device)
{
	delete static_cast<RAM32Variable*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetSharedRAM(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new SharedRAM(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteSharedRAM(IDevice* device)
{
	delete static_cast<SharedRAM*>(device);
}

//----------------------------------------------------------------------------------------------------------------------
static IDevice* GetTimedBufferIntDeviceDeviceInfo(const wchar_t* implementationName, const wchar_t* instanceName, unsigned int moduleID)
{
	return static_cast<IDevice*>(new TimedBufferIntDevice(implementationName, instanceName, moduleID));
}

//----------------------------------------------------------------------------------------------------------------------
static void DeleteTimedBufferIntDeviceDevice(IDevice* device)
{
