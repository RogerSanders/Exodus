...
class RAM16Variable :public RAMBase<unsigned short>
{
public:
	// Constructors
	RAM16Variable(const std::wstring& implementationName, const std::wstring& instanceName, unsigned int moduleID);
