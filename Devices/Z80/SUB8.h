...
{
public:
	virtual SUB8* Clone() {return new SUB8();}
	virtual SUB8* ClonePlacement(void* buffer) {return new(buffer) SUB8();}
	...
	{
		return Disassembly(L"SUB", target.Disassemble() + L", " + source.Disassemble());
	}
