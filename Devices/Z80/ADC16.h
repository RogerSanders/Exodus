...
{
public:
	virtual ADC16* Clone() const {return new ADC16();}
	virtual ADC16* ClonePlacement(void* buffer) const {return new(buffer) ADC16();}
	...
	{
		return Disassembly(L"ADC", _target.Disassemble() + L", " + _source.Disassemble());
	}
