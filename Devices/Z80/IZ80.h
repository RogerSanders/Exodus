...
public:
	...
	inline void SetF(unsigned int data);
	inline unsigned int GetB() const;
	inline void SetB(unsigned int data);
	inline unsigned int GetC() const;
	inline void SetC(unsigned int data);
	inline unsigned int GetD() const;
	inline void SetD(unsigned int data);
	inline unsigned int GetE() const;
	inline void SetE(unsigned int data);
	inline unsigned int GetH() const;
	inline void SetH(unsigned int data);
	inline unsigned int GetL() const;
	inline void SetL(unsigned int data);

	inline unsigned int GetAF() const;
	inline void SetAF(unsigned int data);
	inline unsigned int GetBC() const;
	inline void SetBC(unsigned int data);
	inline unsigned int GetDE() const;
	inline void SetDE(unsigned int data);
	inline unsigned int GetHL() const;
	inline void SetHL(unsigned int data);

	inline unsigned int GetA2() const;
	inline void SetA2(unsigned int data);
	inline unsigned int GetF2() const;
	inline void SetF2(unsigned int data);
	inline unsigned int GetB2() const;
	inline void SetB2(unsigned int data);
	inline unsigned int GetC2() const;
	inline void SetC2(unsigned int data);
	inline unsigned int GetD2() const;
	inline void SetD2(unsigned int data);
	inline unsigned int GetE2() const;
	inline void SetE2(unsigned int data);
	inline unsigned int GetH2() const;
	inline void SetH2(unsigned int data);
	inline unsigned int GetL2() const;
	inline void SetL2(unsigned int data);

	inline unsigned int GetAF2() const;
	inline void SetAF2(unsigned int data);
	inline unsigned int GetBC2() const;
	inline void SetBC2(unsigned int data);
	inline unsigned int GetDE2() const;
	inline void SetDE2(unsigned int data);
	inline unsigned int GetHL2() const;
	inline void SetHL2(unsigned int data);

	inline unsigned int GetIXHigh() const;
	inline void SetIXHigh(unsigned int data);
	inline unsigned int GetIXLow() const;
	inline void SetIXLow(unsigned int data);
	inline unsigned int GetIYHigh() const;
	inline void SetIYHigh(unsigned int data);
	inline unsigned int GetIYLow() const;
	inline void SetIYLow(unsigned int data);

	inline unsigned int GetI() const;
	inline void SetI(unsigned int data);
	inline unsigned int GetR() const;
	inline void SetR(unsigned int data);
	inline unsigned int GetIX() const;
	inline void SetIX(unsigned int data);
	inline unsigned int GetIY() const;
	inline void SetIY(unsigned int data);
