...
//Constructors
//----------------------------------------------------------------------------------------
S315_5313::SpriteListView::SpriteListView(S315_5313* adevice)
:device(adevice)
{
	std::wstring windowTitle = BuildWindowTitle(device->GetModuleDisplayName(), device->GetDeviceInstanceName(), L"Sprite List");
...
//----------------------------------------------------------------------------------------
INT_PTR S315_5313::SpriteListView::WndProcDialog(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
...
//Event handlers
//----------------------------------------------------------------------------------------
INT_PTR S315_5313::SpriteListView::msgWM_INITDIALOG(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
	int tabsize = 20;
...
//----------------------------------------------------------------------------------------
INT_PTR S315_5313::SpriteListView::msgWM_DESTROY(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
	KillTimer(hwnd, 1);
...
//----------------------------------------------------------------------------------------
INT_PTR S315_5313::SpriteListView::msgWM_TIMER(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
	...
	{
		SpriteMappingTableEntry mapping = device->GetSpriteMappingTableEntry(i);
...
//----------------------------------------------------------------------------------------
INT_PTR S315_5313::SpriteListView::msgWM_COMMAND(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
	if(HIWORD(wparam) == LBN_DBLCLK)
	{
		...
		case IDC_VDP_SPRITELIST_LIST:{
			...
			device->OpenSpriteListDetailsView(targetSpriteIndex);
			break;}
		}
	}
