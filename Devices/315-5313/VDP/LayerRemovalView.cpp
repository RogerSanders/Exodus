...
//Constructors
//----------------------------------------------------------------------------------------
VDP::LayerRemovalView::LayerRemovalView(VDP* adevice)
:device(adevice)
{
...
//----------------------------------------------------------------------------------------
INT_PTR VDP::LayerRemovalView::WndProcDialog(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
...
//Event handlers
//----------------------------------------------------------------------------------------
INT_PTR VDP::LayerRemovalView::msgWM_INITDIALOG(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
...
//----------------------------------------------------------------------------------------
INT_PTR VDP::LayerRemovalView::msgWM_CLOSE(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
	DestroyWindow(hwnd);
...
//----------------------------------------------------------------------------------------
INT_PTR VDP::LayerRemovalView::msgWM_COMMAND(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
