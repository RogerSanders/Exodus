...
//Constructors
//----------------------------------------------------------------------------------------
S315_5313::PortMonitorView::PortMonitorView(S315_5313* adevice)
:device(adevice), initializedDialog(false), currentControlFocus(0)
{
	...
	SetDialogTemplateSettings(windowTitle, (HINSTANCE)device->GetAssemblyHandle(), MAKEINTRESOURCE(IDD_S315_5313_PORTMONITOR));
}

//----------------------------------------------------------------------------------------
//Member window procedure
//----------------------------------------------------------------------------------------
INT_PTR S315_5313::PortMonitorView::WndProcDialog(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
...
//Event handlers
//----------------------------------------------------------------------------------------
INT_PTR S315_5313::PortMonitorView::msgWM_INITDIALOG(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
	UpdateDlgItemBin(hwnd, IDC_S315_5313_PORTMONITOR_LISTSIZE, device->portMonitorListSize);
	CheckDlgButton(hwnd, IDC_S315_5313_PORTMONITOR_SRREAD, (device->logStatusRegisterRead)? BST_CHECKED: BST_UNCHECKED);
	CheckDlgButton(hwnd, IDC_S315_5313_PORTMONITOR_DPREAD, (device->logDataPortRead)? BST_CHECKED: BST_UNCHECKED);
	CheckDlgButton(hwnd, IDC_S315_5313_PORTMONITOR_HVREAD, (device->logHVCounterRead)? BST_CHECKED: BST_UNCHECKED);
	CheckDlgButton(hwnd, IDC_S315_5313_PORTMONITOR_CPWRITE, (device->logControlPortWrite)? BST_CHECKED: BST_UNCHECKED);
	CheckDlgButton(hwnd, IDC_S315_5313_PORTMONITOR_DPWRITE, (device->logDataPortWrite)? BST_CHECKED: BST_UNCHECKED);
...
//----------------------------------------------------------------------------------------
INT_PTR S315_5313::PortMonitorView::msgWM_TIMER(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
...
//----------------------------------------------------------------------------------------
INT_PTR S315_5313::PortMonitorView::msgWM_COMMAND(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
