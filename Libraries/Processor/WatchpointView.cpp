...
//----------------------------------------------------------------------------------------
INT_PTR Processor::WatchpointView::msgWM_CLOSE(HWND hwnd, WPARAM wparam, LPARAM lparam)
{
	KillTimer(hwnd, 1);
	DestroyWindow(hwnd);
		...
		if(newText != previousText)
		{
			...
			case IDC_PROCESSOR_WATCH_LOCCONDDATA1:{
				...
				if(updateName)
				{
					...
					IntToStringBase16(watchpoint.GetLocationConditionData1(), watchNameFromLocation, device->GetAddressBusCharWidth(), false);
